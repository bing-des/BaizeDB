...
impl DbOps for Arc<MySqlPool> {
    ...
    async fn list_schemas(
        &self,
        database: &str,
    ) -> Result<Vec<crate::database::db_ops::SchemaMeta>, String> {
    ...
    async fn list_tables(
        ...
        database: &str,
        schema: Option<&str>,
    ) -> Result<Vec<crate::database::db_ops::TableMeta>, String> {
    ...
    async fn list_columns(
        ...
        database: &str,
        table: &str,
    ) -> Result<Vec<crate::database::db_ops::ColumnMeta>, String> {
...
impl AnyDbPool {
    pub async fn list_databases(
        &self,
    ) -> Result<Vec<crate::database::db_ops::DatabaseMeta>, String> {
        match self {
